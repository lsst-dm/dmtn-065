...
The definitions of possible and necessary are ultimately left to the
discretion of Rubin Data Management in Operations.
...
not to place limits on what Special Processing might be done.
Note in particular that secondary science goals may be considered
to require User-Generated Processing. 
