...
\addtohist{2}{2021-12-01}{Updated per DM-20375.}{Melissa Graham}
}
...
\textbf{Shorter Exposures.} The camera constraint on the minimum supported exposure time is currently 1 second (stretch goal 0.1 seconds; LSR-REQ-0111 in \citeds{LSE-29}).
