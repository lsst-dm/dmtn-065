...
science goals from Special Programs, and user processing will be supported with
computational resources.
(Section~\ref{ssec:sci_comp})
...
remains to be determined \citedsp{PSTN-055}.
...
Data products from Special Programs are subject to the Rubin Data Policy \citedsp{RDO-013}
...
described in the Data Management Science Pipelines Design \citeds{LDM-151}
...
\emph{do not} meet the conditions of "possible and necessary" as defined in Section~\ref{ssec:sci_sproc}.
Computational tools, resources, and support will be provided by Rubin for User-Generated
Processing, as described in Section~\ref{ssec:sci_comp} and Section~\ref{ssec:proc_user}.
