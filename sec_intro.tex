...
\subsection{Main Survey and Wide-Fast-Deep (WFD)}
...
Data from the Main Survey will be processed with regular (non-special) processing.
...
(LSE-163) that are designed for, and will be applied to, the Main Survey's observations.
...
or beyond the Main Survey footprint which have a distinct observing strategy from
...
by regular processing for the Main Survey.
